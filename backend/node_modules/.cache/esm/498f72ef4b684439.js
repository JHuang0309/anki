let fs,jwt,AsyncLock,InputError,AccessError;_4b6‍.x([["save",()=>save],["reset",()=>reset],["getUserIdFromAuthorization",()=>getUserIdFromAuthorization],["getUserIdFromEmail",()=>getUserIdFromEmail],["login",()=>login],["logout",()=>logout],["register",()=>register],["getDecks",()=>getDecks],["setDecks",()=>setDecks],["createDeck",()=>createDeck],["deleteDeck",()=>deleteDeck],["getCards",()=>getCards],["getCard",()=>getCard],["createCard",()=>createCard],["updateCard",()=>updateCard],["deleteCard",()=>deleteCard],["assertValidUserId",()=>assertValidUserId],["assertAdminUserId",()=>assertAdminUserId],["userGet",()=>userGet],["userAdminChange",()=>userAdminChange],["userUpdate",()=>userUpdate]]);_4b6‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_4b6‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_4b6‍.w("async-lock",[["default",["AsyncLock"],function(v){AsyncLock=v}]]);_4b6‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);/**************************************************************************************/
...
/*************************************************************************************/
 ...
 // library used to ensure shared resources are managed appropriately
 ...
 */
  ...
  _4b6‍.g.console.log("Service - getUserIdFromAuth:", authorization)
...
// access token and user id object using 'login().then(res => ... )'
       const login = (email, password) => dataLock((resolve, reject) => {
  ...
  dataLock((resolve, reject) => {
    ...
    resolve();
       ...
       const register = (email, password, name) => dataLock((resolve, reject) => {
...
***************************************************************/
       ...
       const getDecks = (authUserId) =>
  dataLock((resolve, reject) => {
    resolve(users[authUserId].decks);
  });

       const setDecks = (authUserId, newDecks) =>
  dataLock((resolve, reject) => {
    users[authUserId].decks = newDecks;
    resolve();
  });

         const createDeck = (authUserId, title) =>
    dataLock((resolve, reject) => {
      ...
      resolve();
         ...
         const deleteDeck = (authUserId, deckId) => {
    dataLock((resolve, reject) => {
...
***************************************************************/
  ...
  dataLock((resolve, reject) => {
    ...
    resolve();
       ...
       const updateCard = (authUserId, cardDetails) => {
  dataLock((resolve, reject) => {
    const userCards = users[authUserId].cards;
    const cardIndex = userCards.findIndex(c => c.id === cardDetails.id);
    if (cardIndex === -1) {
    ...
    resolve(users[authUserId].cards[cardIndex]);
       ...
       const deleteCard = (authUserId, cardId) => {
  dataLock((resolve, reject) => {
...
***************************************************************/
       ...
       const assertValidUserId = (userId) => dataLock((resolve, reject) => {
  if (!(userId in users)) {
  ...
  resolve();
       ...
       const assertAdminUserId = (userId) => dataLock((resolve, reject) => {
  ...
  resolve();
       ...
       const userGet = (userId) => dataLock((resolve, reject) => {
  ...
  // access  user object using 'userGet(id).then(res => ... )'
       ...
       const userAdminChange = (authUserId, userId, turnon) => dataLock((resolve, reject) => {
  ...
  resolve();
       ...
       const userUpdate = (authUserId, email, password, name, image) => dataLock((resolve, reject) => {
