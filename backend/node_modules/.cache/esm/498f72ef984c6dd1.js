let fs,jwt,AsyncLock,InputError,AccessError;_984‍.x([["save",()=>save],["reset",()=>reset],["getUserIdFromAuthorization",()=>getUserIdFromAuthorization],["getUserIdFromEmail",()=>getUserIdFromEmail],["login",()=>login],["register",()=>register],["assertValidUserId",()=>assertValidUserId],["assertAdminUserId",()=>assertAdminUserId],["userGet",()=>userGet],["userAdminChange",()=>userAdminChange],["userUpdate",()=>userUpdate]]);_984‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_984‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_984‍.w("async-lock",[["default",["AsyncLock"],function(v){AsyncLock=v}]]);_984‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);/**************************************************************************************/
 ...
 */
       const getUserIdFromAuthorization = authorisation => {
