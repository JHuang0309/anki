let fs,jwt,AsyncLock,InputError,AccessError;_ad4‍.x([["save",()=>save],["reset",()=>reset],["getUserIdFromAuthorization",()=>getUserIdFromAuthorization],["getUserIdFromEmail",()=>getUserIdFromEmail],["login",()=>login],["logout",()=>logout],["register",()=>register],["getSubjects",()=>getSubjects],["setSubjects",()=>setSubjects],["assertValidUserId",()=>assertValidUserId],["assertAdminUserId",()=>assertAdminUserId],["userGet",()=>userGet],["userAdminChange",()=>userAdminChange],["userUpdate",()=>userUpdate]]);_ad4‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_ad4‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_ad4‍.w("async-lock",[["default",["AsyncLock"],function(v){AsyncLock=v}]]);_ad4‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);/**************************************************************************************/
...
***************************************************************/
       ...
       const getSubjects = (authUserId) =>
  userLock((resolve, reject) => {
    resolve(users[authUserId].subjects);
  });

       const setSubjects = (authUserId, subjects) =>
  userLock((resolve, reject) => {
