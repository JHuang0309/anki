...
app.post(
    ...
    performRequest(
        authed(async (req, res, email) => {
          _18d‍.g.console.log("Server logout", email);
          await logout(email);
          return res.json({});
        })
    )
...
app.put(
  ...
  performRequest(
      authed(async (req, res, authUserId) => {
        await setSubjects(authUserId, req.body.title);
        return res.json({});
      })
  )
);
