...
app.post(
    ...
    performRequest(
        authed(async (req, res, email) => {
          _6f4‍.g.console.log("Server logout", email);
          await logout(email);
          return res.json({});
        })
    )
